...
public class DataController {
	...
	public void wirteBookToFile(Book book, String fileName) {
		printWriter.println(book.getBookID()+"|"+book.getBookName()+"|"
												+book.getAuthor()+"|"
												+book.getSpecialization()+"|"
												+book.getPublishYear()+"|"
												+book.getQuantity());
		closeFileAfterWrite(fileName);
	}
	
	public void wirteReaderToFile(Reader reader, String fileName) {
		printWriter.println(reader.getId()+"|"+reader.getFullName()+"|"
												+reader.getAddress()+"|"
...
//				+book.getQuantity());
	...
	public ArrayList<BookReaderManagement> readBRMS(String fileName){
		openFileToRead(fileName);
	...
	public BookReaderManagement createBRMFromData(String data) {
		...
		BookReaderManagement brm=new BookReaderManagement(
				new Book(Integer.parseInt(datas[0])), 
				new Reader(Integer.parseInt(datas[1])),
